...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { city: @organisation.city, description: @organisation.description, name: @organisation.name, regon: @organisation.regon, volontary: @organisation.volontary }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { city: @organisation.city, description: @organisation.description, name: @organisation.name, regon: @organisation.regon, volontary: @organisation.volontary }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
