...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { age: @individual.age, city: @individual.city, description: @individual.description, name: @individual.name, surname: @individual.surname, volontary: @individual.volontary }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { age: @individual.age, city: @individual.city, description: @individual.description, name: @individual.name, surname: @individual.surname, volontary: @individual.volontary }
    assert_redirected_to individual_path(assigns(:individual))
  end
